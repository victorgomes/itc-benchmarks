...
#define MAX_VAL 10
unsigned int memory_allocation_failure_005_gbl = 40;
...
void memory_allocation_failure_012_func_002 (int *pbuf[])
{
	...
	memory_allocation_failure_012_buf2_gbl = (int *) calloc (memory_allocation_failure_012_func_001(1),sizeof(int)); /*Tool should not detect this line as error*/ /*No ERROR:Memory allocation failure */
