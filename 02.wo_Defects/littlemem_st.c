 ...
 * Complexity: struct pointer	Loading
 */
typedef struct {
	int a;
	int b;
...
/*
 * Types of defects: Allocate small size for type - structure  (static)
 * Complexity: struct pointer	Write
 */
typedef struct {
	int a;
	int b;
...
/*
 * Types of defects: Allocate small size for type - union  (static)
 * Complexity: Union of pointer	Write
 */
typedef union {
	char a;
	short b;
