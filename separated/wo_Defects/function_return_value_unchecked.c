...
{
	int a=1;
	char buf = function_return_value_unchecked_003_func_001(); /*Tool should not detect this line as error*/ /*No ERROR:Return value of function never checked*/
	a--;
	if (a==0)
	{
		if(buf != '\0')
...
void function_return_value_unchecked_004 ()
{
    ...
    s= function_return_value_unchecked_004_s_001_func_001(); /*Tool should not detect this line as error*/ /*No ERROR:Return value of function never checked*/
    int flag = 1;
	switch (flag)
	{
		case 1:
...
void function_return_value_unchecked_005 ()
{
	...
	for(i=0;i<10;i++)
	{
		u = function_return_value_unchecked_005_s_001_func_001(); /*Tool should not detect this line as error*/ /*No ERROR:Return value of function never checked*/
       	if(u.b >0)
        		u.c= 60.5;
	}
}
