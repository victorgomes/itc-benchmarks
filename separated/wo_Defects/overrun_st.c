...
{
	int buf[5];
	buf[overrun_st_017_func_001()] = 1; /*Tool not should detect this line as error*/ /*No ERROR: buffer overrun */
        sink = buf[4];
}

/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1-dimensional global array	  int	Function arguments	Write
 */
...
void overrun_st_021 ()
{
	...
	index1 = index;
	index2 = index1;
	buf[index2] = 1; /*Tool not should detect this line as error*/ /*No ERROR: buffer overrun */
        sink = buf[4];
}

/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	char	Alias for 1 weight	Address	Constant	Write
 */
void overrun_st_022 ()
{
	char buf[5];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	short	Alias for 1 weight	Address	Constant	Write
 */
void overrun_st_023 ()
{
	short buf[5];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	int	Alias for 1 weight	Address	Constant	Loading
 */
void overrun_st_024 ()
{
	int buf[5] = {1, 2, 3, 4, 5};
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	int	Alias for 1 weight	Address	Constant	Write
 */
void overrun_st_025 ()
{
	int buf[5];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	long	Alias for 1 weight	Address	Constant	Write
 */
void overrun_st_026 ()
{
	long buf[5];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	float	Alias for 1 weight	Address	Constant	Write
 */
void overrun_st_027 ()
{
	float buf[5];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	double	Alias for 1 weight	Address	Constant	Write
 */
void overrun_st_028 ()
{
	double buf[5];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: double pointer	int	Alias for 1 weight	Address	Constant	Write
 */
void overrun_st_029 ()
{
	int buf[5];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	int	Also known as double	Address	Variable	Write
 */
void overrun_st_030 ()
{
	int buf[5];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	int	Pointer variables  array	-	Constant	Write
 */
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	int	Alias for 1 weight	Address	Variable	Write
 */
void overrun_st_032 ()
{
	int buf[5];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	int	Alias for 1 weight	Address	Value of random variable	Write
 */
void overrun_st_033 ()
{
	int buf[5];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	int	Alias for 1 weight	Address	Linear equation	Write
 */
void overrun_st_034 ()
{
	int buf[6];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	int	Alias for 1 weight	Address	Nonlinear equation	Write
 */
void overrun_st_035 ()
{
	int buf[6];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	int	Alias for 1 weight	Address	The return value of the function	Write
 */
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	int	Alias for 1 weight	Address	Function arguments	Write
 */
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	int	Alias for 1 weight	Address	An array of element values	Write
 */
void overrun_st_038 ()
{
	int buf[5];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	int	Alias for 1 weight	Address	Alias for 1 weight	Write
 */
void overrun_st_039 ()
{
	int buf[5];
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 1 single pointer	int	Alias for 1 weight	Address	Also known as double Alias	Write
 */
void overrun_st_040 ()
{
	int buf[5];
...
void overrun_st_044 ()
{
	...
	{
		*p = 1;
		p ++; /*Tool not should detect this line as error*/ /*No ERROR: buffer overrun */
	}
}

/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexities: an array	An array of
 */
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity: 	An array of pointer
 */
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity:  for 1-dimensional array array size
 */
void overrun_st_049 ()
{
	int buf[] = {1, 2, 3, 4, 5};
...
/*
 * Types of defects: buffer overruns ( static buffer )
 * Complexity:  for two-dimensional array array size
 */
void overrun_st_050 ()
{
	int buf[][6] =
